...
class AssistantSettingValueRequest extends ResourceRequest
{
    public function rules(): array
    {
        ...
        $allowsEmpty = $setting !== null
            && collect($setting->ui_options ?? [])
                ->contains(fn (array $option): bool => ($option['value'] ?? null) === '');

        $valueAgainstSetting = function (string $attribute, mixed $value, Closure $fail) use ($setting): void {
        ...
        return [
            ...
            'setting' => [
                ...
                function (string $attribute, mixed $value, Closure $fail): void {
                    ...
                    if ($assistantId === null || $settingId === null) {
                        return;
                    }
