...
final class ModelSchema extends Schema
{
    ...
    protected const ATTRIBUTES = [
        'label', 'model_id', 'provider_id', 'active', 'descriptions', 'model_type', 'documentation_url', 'deprecation_date', 'input', 'output', 'parameters', 'native_capabilities', 'settings', 'limits', 'pricing', 'flags', 'tools', 'usage_rules',
    ];
