...
final class OpenResponsesResource
{
    ...
    public static function resource(
        ...
        return [
            ...
            // The published Open Responses spec types these as non-nullable; the
            // stateless proxy echoes the provider-neutral defaults it applies when the
            // client did not request specific values.
            'temperature' => 1,
            'top_p' => 1,
            'presence_penalty' => 0,
            'frequency_penalty' => 0,
