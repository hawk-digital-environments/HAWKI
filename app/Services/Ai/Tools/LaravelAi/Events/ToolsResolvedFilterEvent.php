...
class ToolsResolvedFilterEvent
{
     ...
     * @param AgentRequestContext $parameterSource The parameter source for the current request, containing the model and other contextual information.
    ...
    public function __construct(
        ...
        private readonly AgentRequestContext $parameterSource,
     ...
     */
    public function getParameterSource(): AgentRequestContext
    {
