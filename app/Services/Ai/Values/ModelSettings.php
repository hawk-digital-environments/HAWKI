...
class ModelSettings implements \JsonSerializable, CastableInstanceInterface
{
    ...
    private function __construct(
        ...
        private readonly AiModelSettingRegistry $settingRegistry
    )
    {
    }
    ...
    {
        return isset($this->settings[$key]) || ($includeDefault && $this->settingRegistry->has($key));
    }
    ...
    {
        return $this->settings[$key] ?? $this->settingRegistry->get($key) ?? $default;
    }
     ...
     * When $settingRegistry is omitted it is resolved from the application container.
     */
