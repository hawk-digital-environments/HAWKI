 ...
 * provider config → **model defaults** → per-request overrides (resolved by {@see \App\Services\Ai\Values\ParameterSource}).
 *
...
class ModelParameters implements CastableInstanceInterface, \JsonSerializable
{
     ...
     *
     * Used by {@see \App\Services\Ai\Values\ParameterSource::getAdditionalParameters()}
