 ...
 *   (e.g. {@see ModelParameters} under `model_parameters`). They are guaranteed to be
 ...
 * {@see \App\Services\Ai\Values\ParameterSource} merges them with model-level and
...
final class ProviderSettings implements CastableInstanceInterface
{
    ...
    private array $instanceKeys = [
        WellKnownProviderSettings::MODEL_PARAMETERS => ModelParameters::class
    ];
     ...
     * Always present — guaranteed to be a valid {@see ModelParameters} instance even when
     ...
     * These values are forwarded to the {@see \App\Services\Ai\ProviderAdapters\Contracts\ProviderAdapterInterface}
