...
interface WellKnownCapabilities
{
    ...
    /**
     * Defines if the model has access to a web fetch capability.
     * This is a more advanced capability than web search, as it allows the model to fetch the content of a specific URL and use it in its reasoning.
     */
    public const string WEB_FETCH = 'web_fetch';

    /**
     * Defines if the model has access to a code execution capability.
     * This allows the model to execute code in a sandboxed environment and use the result in its reasoning.
     */
    public const string CODE_EXECUTION = 'code_execution';

    /**
     * Defines if the model is able to call tools.
     * This allows the model to call our internal tools that are provided by HAWKI,
