...
class ExampleBuilder
{
    ...
    /**
     * Hardcoded request/response examples for custom actions and endpoints.
     ...
     *
     * @return null|array the request body example, or null if no writable fields exist
     */
     ...
     *
     * @return null|array the request body example, or null if not defined in ACTION_EXAMPLES
     */
