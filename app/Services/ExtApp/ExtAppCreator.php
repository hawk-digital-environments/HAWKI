...
use App\Services\ExtApp\Values\AppCreationResult;
use DB;
use Hawk\HawkiCrypto\AsymmetricCrypto;
use Throwable;

readonly class ExtAppCreator
{
    public function __construct(
        private AsymmetricCrypto $crypto,
        private UserRepository   $userDb,
        private ExtAppRepository $appDb
    )
    {
    }
    ...
    protected function createAppUser(string $appName): User
    {
        ...
        return $this->userDb->createUserToActAsExternalApp(
            name: $appName,
            email: $email,
