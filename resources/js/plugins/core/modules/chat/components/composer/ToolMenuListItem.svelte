...
-->
<script lang="ts">
    import {DropdownMenuCheckboxItem} from '@hawk-hhg/hawki-svelte-components';
    ...
    import ArrowRight01Icon from '@hawk-hhg/hawki-svelte-components/ui/icons/iconset/ArrowRight01Icon.svelte';
