<script lang="ts">
import ReleaseStage from "$plugins/assistants/components/assistantBuilderComponents/ReleaseStage.svelte";
...
import InfoPanel from "$plugins/assistants/components/info/InfoPanel.svelte";
