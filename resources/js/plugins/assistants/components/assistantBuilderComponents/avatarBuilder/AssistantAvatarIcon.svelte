...
<style>
    ...
    .icon-container.sizeSmall{
        width: 3rem;
        height: 3rem;
    }
    .icon-container.sizeMedium{
        width: 5rem;
        height: 5rem;
    }
    .icon-container.sizeLarge{
        width: 7rem;
        height: 7rem;
    }
    .icon-container.roundEdge{
