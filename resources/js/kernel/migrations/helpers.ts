 ...
 * @deprecated Use `useApp().migration.hasPending` instead. This function is a legacy wrapper and will be removed in future versions.
 */
 ...
 * @deprecated Use `useApp().migration.apply(runType)` instead. This function is a legacy wrapper and will be removed in future versions.
 */
