...
<span {...restProps} class={["logo", className]} role="img" aria-label={label}>
    <svg class="mark" viewBox="0 0 336 96" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <path d="M251.795 24.192L229.907 94.72H214.547L200.339 42.624L186.131 94.72H170.771L148.755 24.192H163.603L178.323 80.896L193.299 24.192H208.531L222.867 80.64L237.459 24.192H251.795Z" fill="currentColor"/>
        <path d="M284.204 59.52L316.716 94.72H297.004L270.892 64.384V94.72H256.3V0H270.892V55.04L296.492 24.192H316.716L284.204 59.52Z" fill="currentColor"/>
        <path d="M335.367 24.192V94.72H320.775V24.192H335.367Z" fill="currentColor"/>
    </svg>
</span>
