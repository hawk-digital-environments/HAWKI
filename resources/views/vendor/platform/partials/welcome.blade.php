<div class="bg-white rounded-top shadow-sm mb-4 rounded-bottom">
    ...
    <div class="row g-0">
        <div class="col col-lg-7 mt-6 p-4">
            ...
            <p class="text-balance">
                With HAWKI2, your university's own data protection-compliant platform for generative AI enters the next phase of development. 
            </p>
        </div>
    ...
    <div class="row bg-light m-0 p-md-4 p-3 border-top rounded-bottom g-md-5 text-balance">
        ...
        <div class="col-md-6 my-2">
            <h3 class="text-muted fw-light lh-lg d-flex align-items-center">
                <x-orchid-icon path="bs.rocket-takeoff"/>
        ...
        <div class="col-md-6 my-2">
            <h3 class="text-muted fw-light lh-lg d-flex align-items-center">
                <x-orchid-icon path="bs.house-gear"/>
