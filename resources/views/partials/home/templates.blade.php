	...
	<div class="message" id="">
		<div class="message-wrapper">
			...
			<div class="message-controls">
				<div class="controls">
					<div class="buttons">
						<button id="copy-btn" class="btn-xs reaction-button fast-access-btn " onclick="CopyMessageToClipboard(this);" onmousedown="reactionMouseDown(this);" onmouseup="reactionMouseUp(this)">
							<x-icon name="copy"/>
							<div class="reaction">{{ $translation["Copied"] }}</div>
							<div class="tooltip">{{ $translation["CopyToolTip"] }}</div>
						</button>
						<button id="edit-btn" class="btn-xs reaction-button fast-access-btn " onclick="editMessage(this)" onmousedown="reactionMouseDown(this);" onmouseup="reactionMouseUp(this)">
							<x-icon name="edit"/>
							<div class="tooltip">{{ $translation["EditToolTip"] }}</div>
						</button>
						<button id="speak-btn" class="btn-xs reaction-button fast-access-btn " onclick="messageReadAloud(this)" onmousedown="reactionMouseDown(this);" onmouseup="reactionMouseUp(this)">
							<x-icon name="volume"/>
							<div class="tooltip">{{ $translation["SpeakToolTip"] }}</div>
						</button>
						<button id="regenerate-btn" class="btn-xs reaction-button fast-access-btn editor-only " onclick="onRegenerateBtn(this)" onmousedown="reactionMouseDown(this)" onmouseup="reactionMouseUp(this);">
							<x-icon name="rotation"/>
							<div class="tooltip">{{ $translation["RegenerateToolTip"] }}</div>
						</button>
						<button id="thread-btn" class="btn-xs reaction-button fast-access-btn " onclick="onThreadButtonEvent(this)" onmousedown="reactionMouseDown(this);" onmouseup="reactionMouseUp(this)">
