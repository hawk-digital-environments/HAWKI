...
<div class="mb-3">
        ...
        <div class="d-flex justify-content-between align-items-start">
            <div>
                <h3 class="text-dark fw-light mb-1">
                    Tool Use per Provider ({{ $monthName }})
                </h3>
                <p class="text-muted small mb-0">
                    Total tool uses and most used tools per API provider with breakdown.
                </p>
            </div>
        </div>
    </div>
    ...
    @if(count($toolUseMetrics) > 0)
        <div class="row" id="toolUseMetricsContainer">
    ...
    @else
        <div class="bg-white rounded shadow-sm p-4">
            <p class="text-muted text-center mb-0">No tool use data available for this period.</p>
        </div>
    @endif
</div>
