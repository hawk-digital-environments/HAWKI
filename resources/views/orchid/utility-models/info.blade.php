<div class="bg-white rounded shadow-sm p-4 mb-4 mt-3">
    <div class="d-flex align-items-center mb-3">
        <i class="icon-info text-primary me-3" style="font-size: 2rem;"></i>
        <h3 class="mb-0">About Utility Models</h3>
    </div>
    
    <div class="mb-4">
        <p>
            Utility models are specialized AI models used by the system for different automated tasks.
            Configuring the right models for each task ensures optimal performance and efficiency.
        </p>
        
        <ul class="mb-3">
            <li class="mb-2">
                <strong>Default Model:</strong> Used when a user hasn't explicitly chosen a model. This should be a
