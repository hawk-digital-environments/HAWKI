...
return new class() extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create('assistants', static function (Blueprint $table): void {
            ...
            $table->string('requested_release_stage')->nullable();
        ...
        Schema::create('assistant_versions', static function (Blueprint $table): void {
            ...
            // Prevents concurrent AssistantUpdatedVersion listeners from
            // inserting duplicate (assistant_id, version) pairs.
            $table->unique(['assistant_id', 'version'], 'assistant_versions_assistant_id_version_unique');
        });
