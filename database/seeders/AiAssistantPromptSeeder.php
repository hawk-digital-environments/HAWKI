...
class AiAssistantPromptSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Array mit allen Standard-Prompts (prompt_type entspricht JSON translation keys)
        $systemPrompts = [
            ...
            [
                'prompt_type' => 'Improvement_Prompt',
                'language' => 'de_DE',
