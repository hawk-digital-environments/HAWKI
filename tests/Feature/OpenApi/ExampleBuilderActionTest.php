...
class ExampleBuilderActionTest extends TestCase
{
    ...
    public function testAttachmentActionResponseExampleIsDefined(): void
    {
        $example = $this->builder->getActionResponseExample('assistants', 'attachment');

        self::assertNotNull($example);
        self::assertSame('assistants', $example['data']['type']);
        self::assertSame('1', $example['data']['id']);
    }
}
