...
#[CoversClass(StreamController::class)]
class StreamControllerAiReqTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->withoutMiddleware(ExternalAccessMiddleware::class);
        $this->withoutMiddleware(AppAccessMiddleware::class);
    ...
    private function bindMockAiService(AiResponse $response, string $modelId = 'gpt-4'): void
    {
        ...
        $this->app->instance(AiService::class, new AiService($mockFactory, 'hawki'));
    }
    ...
    public function test_returns_422_when_model_missing(): void
    {
        ...
        $response
            ...
            ->assertJson([
                ...
                'errors' => [
                    'payload.model' => [
                        'The payload.model field is required.',
                    ],
                ],
            ]);
    }
    ...
    public function test_returns_422_when_messages_missing(): void
    {
        ...
        $response
            ...
            ->assertJson([
                ...
                'errors' => [
                    'payload.messages' => [
                        'The payload.messages field is required.',
                    ],
                ],
            ]);
    }
            ...
            ->assertJson([
                ...
                'errors' => [
                    'payload.messages.0.role' => [
                        'The payload.messages.0.role field is required.',
                    ],
                ],
            ]);
    }
            ...
            ->assertJson([
                ...
                'errors' => [
                    'payload.messages.0.content' => [
                        'The payload.messages.0.content field is required.',
                    ],
                    'payload.messages.0.content.text' => [
                        'The payload.messages.0.content.text field is required.',
                    ],
                ],
            ]);
    }
    ...
    {
        $this->withMiddleware(ExternalAccessMiddleware::class);
