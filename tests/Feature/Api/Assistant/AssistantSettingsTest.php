...
class AssistantSettingsTest extends TestCase
{
    ...
    public function testSettingChangeSkipsVersionWhenDraft(): void
    {
        $owner = User::factory()->create();
        $assistant = Assistant::factory()->create([
            'creator_id' => $owner->id,
    ...
    public function testUpdateRecordsVersionWhenOrganizational(): void
    {
        $owner = User::factory()->create();
        $assistant = Assistant::factory()->create([
            'creator_id' => $owner->id,
        ...
        self::assertSame('professional', $assistant->fresh()->settingValues->firstWhere('setting_id', $this->formality->id)->value);
        self::assertEquals(['assistant_setting_values'], $assistant->assistantVersions()->latest('version')->first()->changed_keys);
    }
    ...
    public function testDeleteRecordsVersionWhenOrganizational(): void
    {
        ...
        $this->jsonApiRaw('delete', "/api/hawki/v1/assistant-setting-values/{$value->id}")
            ->assertNoContent();
