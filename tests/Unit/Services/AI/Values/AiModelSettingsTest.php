...
#[CoversClass(ModelSettings::class)]
...
class AiModelSettingsTest extends TestCase
{
    ...
    private function makeSettings(array $data = [], ?AiModelSettingRegistry $registry = null): ModelSettings
    {
        return ModelSettings::fromArray($data, $registry ?? $this->makeRegistry());
    }
    ...
    public function testItConstructs(): void
    {
        ...
        static::assertInstanceOf(ModelSettings::class, $sut);
    }
    ...
    {
        $sut = ModelSettings::fromArray([], $this->makeRegistry());
        static::assertInstanceOf(ModelSettings::class, $sut);
    }
