...
class AiProviderSettingsTest extends TestCase
{
    ...
    {
        $sut = ProviderSettings::fromArray([]);
        static::assertInstanceOf(AiModelParameters::class, $sut->getModelParameters());
    }
    ...
    {
        $sut = ProviderSettings::fromArray([]);
        $params = AiModelParameters::fromArray(['temperature' => 0.3]);
    ...
    public function testItSetThrowsForInvalidTypeOnInstanceKey(): void
    {
        ...
        $this->expectExceptionMessage('Value for model_parameters must be an instance of ' . AiModelParameters::class);
