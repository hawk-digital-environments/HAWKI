...
> **Note:** These variables control built-in model capabilities (file upload, vision, web search). For user-installable tools such as function-calling tools and MCP tools, see [AI Models & Tools](10.2-AI%20Models%20and%20Tools.md).
...
> Currently, native web search is available only for Google Gemini and OpenAI GPT4.1 and GPT5 models. For other providers, web search can be added via a function-calling tool or MCP server — see [AI Models & Tools](10.2-AI%20Models%20and%20Tools.md).
...
- [AI Models & Tools](10.2-AI%20Models%20and%20Tools.md) — complete architecture guide for models and tools, including MCP servers and function-calling tools
