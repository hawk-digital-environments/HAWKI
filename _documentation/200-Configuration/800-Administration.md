...
Imports run on the queue and preserve records edited in the panel. Test/discovery actions call the configured services. MCP discovery reconciles the server's reported tools; function-tool implementations remain defined in PHP.
