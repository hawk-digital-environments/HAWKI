...
Backend mechanisms that bridge to the Svelte SPA. Most of the legacy bridge (`OldUiBridge`, the Svelte snippet bridge, `AssetCacheBusting`) is deprecated transition scaffolding. The two pieces that are not deprecated:
