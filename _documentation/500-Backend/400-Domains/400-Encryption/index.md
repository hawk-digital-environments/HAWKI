...
The encryption domain index. The single home for the three cryptographic tiers, salts, and wire formats is [Encryption](./410-Encryption.md). Per-domain storage:
