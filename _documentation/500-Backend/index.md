...
| [Reference](./500-Reference/index.md) | Lookup catalogues (artisan commands, shared utilities, health checks, scheduling, SSRF protection). Code is truth. |
...
|---|---|
| **Contribute code** (new features, bug fixes) | [Concepts → Layers & Domains](./200-Concepts/100-Layers-and-Domains.md) → your domain section |
...
| **Deploy or operate HAWKI** (configure, monitor, troubleshoot) | [Reference](./500-Reference/index.md) → [Encryption](./400-Domains/400-Encryption/410-Encryption.md) (salts in production) |
