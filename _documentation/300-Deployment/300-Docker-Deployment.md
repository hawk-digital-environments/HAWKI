...
Instead of manually setting up PHP and Apache [as described in "Apache Deployment"](100-Apache-Server.md), you can use
...
* Authentication - To authenticate users you can use LDAP, OpenID Connect or SAML, adjust the `.env` file as
  described in the `Setup Authentication Methods` section of the [Apache Deployment](100-Apache-Server.md) guide.
* Model configuration - You find a default `model_providers.php` file in the `_docker_production` directory, which
  ...
  [Apache Deployment](100-Apache-Server.md) guide.
...
balancers. See the [Health Check documentation](600-Health-Check.md) for details.
