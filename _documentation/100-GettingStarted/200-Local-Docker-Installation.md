...
please refer to the [production installation guide](../300-Deployment/300-Docker-Deployment.md), as it is more secure and
robust.
...
the [Local Installation Guide](100-Local-Installation.md),
...
Follow the "Configuration -> API KEYS" section of the [Local Installation Guide](100-Local-Installation.md) to define
your API keys.
...
Follow the "Configuration -> Authentication" section of the [Local Installation Guide](100-Local-Installation.md) to
create
the test user file.
