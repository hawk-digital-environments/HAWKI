...
> **Planned Svelte rewrite:** The HAWKI frontend is planned to be rewritten as a full Svelte SPA. We are taking a **hybrid approach**: Blade templates remain the leading rendering layer, but we are progressively migrating UI sections into Svelte components. **Do not add new code to the legacy vanilla-JS layer** (`public/js/`). All new frontend work must follow the patterns in the frontend documentation.

The frontend is documented in full detail under **[Frontend](./Frontend/)**. The sections most relevant when contributing are:

| Topic | Document |
|---|---|
| Tech stack, directory structure, snippets | [Svelte Frontend](./Frontend/100-Svelte-Frontend.md) |
| Component authoring conventions (props, binding, context, ID generation) | [Writing Svelte Components](./Frontend/400-Components/index.md) |
| CSS tokens, cascade layers, breakpoints, dark mode | [Styling](./Frontend/200-Styling.md) |
| Config, connection, API fetch helpers, resource schemas | [Data Layer](./Frontend/300-Data/index.md) |
| Reactive stores (`aiModelStore`, `aiToolStore`, etc.) | [Stores](./Frontend/300-Data/100-Stores.md) |
| `__()` translation function and replacement syntax | [Translations](./Frontend/500-Utilities/100-Translations.md) |
| Shared utilities (`debounce`, `buildStorageFileUrl`, transitions, …) | [Misc Utilities](./Frontend/500-Utilities/index.md) |
| Available UI primitive components | [UI Primitives](./Frontend/400-Components/100-UI-Primitives.md) |
| Composable helper components (`Link`, `SnippetOrString`, `Breakpoint`) | [Utility Components](./Frontend/400-Components/200-Utility-Components.md) |

---

## Styling

See [Styling](./Frontend/200-Styling.md) for the full reference — tokens, cascade layers, breakpoints, dark mode, and component style patterns.
