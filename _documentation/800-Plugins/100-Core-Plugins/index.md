...
For how plugins are discovered and dispatched internally, see [Frontend Architecture → Plugin Internals](../../600-Frontend/300-Architecture/130-Plugin-Internals.md). For authoring a plugin, see [Extending HAWKI](../200-Extending-HAWKI/index.md).
